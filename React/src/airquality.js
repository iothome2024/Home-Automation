...
const AirqualityGraph = () => {
    ...
    const fetchData = () => {
      axios.get('http://127.0.0.1:5000/airquality')
        .then(response => {
    ...
    return(
        <div id="airsection">
        <div className='background-air'  style={styles}>
          <div className='chartContainerStyle'data-aos="fade-right" style={styles}>
            <h1 style={styles} className='heading' data-aos="fade-up">Air Quality Sensor Data</h1>
            <div className='lineChartStyle' style={styles} data-aos="fade-in">
                ...
                <Line type="monotone" dataKey="value" name='Airquality' stroke="blue" strokeWidth={1.5} dot={{ stroke: 'white', fill: 'blue', strokeWidth: 2, r: 4 }} />
